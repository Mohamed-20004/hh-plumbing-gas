...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-10 w-10 items-center justify-center rounded-none border border-border bg-background hover:border-foreground/30 transition-colors"
